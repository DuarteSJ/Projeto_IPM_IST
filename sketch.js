  ...
  const GROUP_NUMBER        = 70;      // Add your group number here as an integer (e.g., 2, 3)
  ...
  // Target list
  let targets               = [];
  let legendas_order        = [38, 53, 20, 28, 58, 59, 5, 6, 76, 68, 45, 37, 42, 41, 50, 48, 60, 11, 61, 34, 52, 21, 62, 39, 33, 12, 63, 64, 0, 1, 22, 7, 65, 8, 9, 36, 10, 31, 55, 13, 71, 66, 15, 44, 43, 16, 29, 17, 18, 19, 32, 30, 56, 23, 2, 70, 24, 25, 75, 3, 26, 73, 69, 4, 27, 35, 46, 47, 51, 49, 40, 74, 77, 57, 78, 14, 72, 67, 54, 79];
  ...
  function createTargets(target_size, horizontal_gap, vertical_gap)
  {
    ...
    for (var c = 0; c < GRID_COLUMNS; c++)
    {
      for (var r = 0; r < GRID_ROWS; r++)
      {
        ...
        let target_label = legendas.getString(legendas_order[i], 0);
        let target_id = legendas.getNum(legendas_order[i], 1);     
        i++;
